...
type OrderServiceClient interface {
	...
	ListOrder(ctx context.Context, in *ListOrderRequest, opts ...grpc.CallOption) (*OrderList, error)
}
...
func (c *orderServiceClient) ListOrder(ctx context.Context, in *ListOrderRequest, opts ...grpc.CallOption) (*OrderList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OrderList)
...
type OrderServiceServer interface {
	...
	ListOrder(context.Context, *ListOrderRequest) (*OrderList, error)
...
func (UnimplementedOrderServiceServer) ListOrder(context.Context, *ListOrderRequest) (*OrderList, error) {
